...
export default class CircleChart {
    ...
    initData(data) {
        ...
        this.data = newData;
        const angleNum = this.data.length - 1;
    ...
    initTooltip() {
        ...
        // -2- Create 3 functions to show / hide the tooltip
        this.showTooltip = d => (
            tooltip
            .style('opacity', 1)
    ...
    initLegend_pop() {
        // Add legend: circles
        let [valuesToShow, xCircle, xLabel] = [
    ...
    initLegend_country() {
        ...
        let [distance, allGroups] = [25, ['Asia', 'Europe', 'Americas', 'Africa', 'Oceania']];
